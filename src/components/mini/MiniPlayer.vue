        ...
        <div class="play-box" @click="miniplay">
          ...
          <img class="play-btn" src="../../assets/svg/mini_pause2.svg" alt="" srcset="" v-else>
           <svg width="100%" height="100%" class="svg-process" >
              <!-- 外圈圆 -->
              <circle cx="32" cy="32" r="27" stroke="#dcdcdc" stroke-width="1" fill="none" />
              <!-- 内圈圆，虚线用于展示进度 -->
              <circle cx="32" cy="32" r="27" stroke="#fff" stroke-width="2" fill="none" :stroke-dasharray='circle_process.end'>
                  <!-- svg动画 -->
